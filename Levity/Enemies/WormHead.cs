...
namespace Levity.Enemies
{
    public class WormHead : ModNPC
    {
        ...
        {
            npc.lifeMax = 500555;        //this is the npc health
            npc.damage = 2;    //this is the npc damage
            npc.defense = 17;         //this is the npc defense
            npc.knockBackResist = 0f;
			npc.width = 84 / 2 * 3; //this is where you put the npc sprite width.     important
			npc.height = 95 / 2 * 3; //this is where you put the npc sprite height.   important
            npc.boss = true;
		...
		public override void AI()
			{
				...
				{
				NPC.NewNPC ((int)npc.position.X, (int)npc.position.Y, mod.NPCType ("ElectroDasher"));
				}
			}
